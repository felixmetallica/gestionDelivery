...
//OBTENEMOS LOS ID DE LA DIRECCION Y LO FORMATEAMOS A UN ARRAY PARA PODER RECORRERLO

$idsUrl = $_GET["liquidaciones"];

$lista = explode(",", $idsUrl);
...
$liquidar = new imprimirLiquidacion();
$liquidar -> traerImpresionLiquidacion();
