...
<table style="border-style: solid; border-top-width: 0.5px; border-left-width: 0.5px; border-right-width: 0.5px; border-bottom-width: 0.5px; border-color: #D3D3D3; padding: 5px">
	...
	<tr>
		...
		<td style="width:100%">
			...
			<span style="font-weight: bold; font-size: 10px">COND. VENTA: </span><span style="font-size: 10px">$medioPago[Nombre]</span><br>
			
			<span style="font-weight: bold; font-size: 10px">COND. IVA: </span><span style="font-size: 10px">A CONSUMIDOR FINAL</span>
...
$pdf->Output('factura'.$nroFactura.'.pdf');
