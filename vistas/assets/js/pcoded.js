$.fn.pcodedmenu = function(settings) {
    ...
    var defaults = {
        ...
        HeaderBackground: 'theme6', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        LHeaderBackground: 'theme6', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        NavbarBackground: 'theme6', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ActiveItemBackground: 'theme6', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ...
        HandleThemeBackground: function() {
            function themebackgroundpattern() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('body').attr("themebg-pattern", "theme4");
                }
            };
