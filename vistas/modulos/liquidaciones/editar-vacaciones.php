				...
				if ($value["Fijo"] == 'S') {
					...
					switch ($value["Descripcion"]) {
						...
						case 'Vacaciones':
							...
							echo '<tr>
						 			<th scope="row" class="text-center">'.$value["Codigo"].'</th>
							  		<td><span id="nuevaDescripcionConcepto" class="nuevaDescripcionConcepto valorVaca" idConcepto="'.$value["ConceptoID"].'" descripcionConcepto="'.$value["Descripcion"].'" tipoConcepto="'.$value["Tipo"].'" fijoConcepto="'.$value["Fijo"].'" valorVaca="'.$value["Unidades"].'">'.$value["Descripcion"].'</span></td>
							  		<td class="text-center"><span id="unidades" class="unidades" unidadesConcepto="'.$value["Unidades"].'">'.$value["Unidades"].'</span></td>
							  		<td class="text-center SueldoBasico Anti" sueldo="'.$sueldoBasico.'" valorAntiguedad="'.$value["Total"].'"><span id="sumarSueldo" class="sumarSueldo valorConcepto claseVacaMonto" valorConcepto="'.$value["Total"].'">'.number_format((float)$value["Total"], 2, '.', '').'</span></td>
							  		<td></td>
							  		<td></td>
							  </tr>';
