						...
						case 'Sueldo Basico':
							...
							echo '<tr id="agregarConcepto">
						 			<th scope="row" class="text-center">'.$value["Codigo"].'</th>
							  		...
							  		<td class="text-center SueldoBasico" sueldo="'.$value["Total"].'"><span id="sumarSueldo" class="sumarSueldo valorConcepto" valorConcepto="'.$value["Total"].'">'.number_format((float)$value["Total"], 2, '.', '').'</span></td>
							  		<td></td>
							  		<td></td>
							  </tr>';
